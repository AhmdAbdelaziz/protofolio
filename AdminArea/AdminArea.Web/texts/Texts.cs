    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your AdminArea Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your AdminArea Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "AdminArea";
        }
